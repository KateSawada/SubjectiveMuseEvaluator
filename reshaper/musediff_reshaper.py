...
class MuseDiffReshaper(ReshaperBase):
    def __init__(
        self,
        ...
        **kwargs
        ...
        input shape is (n_songs, 1, n_tracks, n_measure, timestep, n_pitches).
    ...
    def __call__(self, pianoroll: np.ndarray) -> np.ndarray:
        ...
        Args:
            pianoroll (np.ndarray): input tensor.
                shape=(n_songs, 1, n_tracks, n_measure, timestep, n_pitches)
