...
class LpdCleansedReshaper(ReshaperBase):
    def __init__(
        self,
        ...
        **kwargs
        ...
        """reshaper for LPD cleansed dataset.
        input shape is (n_measure, timestep, n_pitches, n_tracks).
    ...
    def __call__(self, pianoroll: np.ndarray) -> np.ndarray:
        ...
        Args:
            pianoroll (np.ndarray): input tensor.
                shape=(n_measure, timestep, n_pitches, n_tracks)
